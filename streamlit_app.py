...
# from pyresparser import config
...
connection = pymysql.connect(host='localhost', user='root', password='A@yush03g')
...
st.set_page_config(
    page_title="Qualify Me",
    page_icon='./Logo/Qi.ico',
)
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'admin' and ad_password == 'root':
                ...
                # Assuming plot_data is your DataFrame containing the data
                labels = plot_data['Predicted_Field'].value_counts().index.tolist()
                values = plot_data['Predicted_Field'].value_counts().values.tolist()
                ...
                labels = plot_data['User_level'].value_counts().index.tolist()
                values = plot_data['User_level'].value_counts().values.tolist()
